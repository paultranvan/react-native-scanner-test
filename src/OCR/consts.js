...
export const COUNTRIES_ISO = [
  ...
  {code2: 'DO', code3: 'DOM', name: 'Dominican Republic (the)', number: '214'},
  ...
  {code2: 'MD', code3: 'MDA', name: 'Moldova (the Republic of)', number: '498'},
  ...
  {code2: 'RU', code3: 'RUS', name: 'Russian Federation (the)', number: '643'},
  ...
  {code2: 'SX', code3: 'SXM', name: 'Sint Maarten (Dutch part)', number: '534'},
  ...
  {code2: 'VG', code3: 'VGB', name: 'Virgin Islands (British)', number: '092'},
